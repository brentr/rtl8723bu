...
static void rtl8723b_set_FwRsvdPage_cmd(PADAPTER padapter, PRSVDPAGE_LOC rsvdpageloc)
{
	...
	RT_PRINT_DATA(_module_hal_init_c_, _drv_notice_, "u1H2CRsvdPageParm:", u1H2CRsvdPageParm, H2C_RSVDPAGE_LOC_LEN);
...
static void rtl8723b_set_FwWoWlanRelated_cmd(_adapter* padapter, u8 enable)
{
	...
	DBG_871X_LEVEL(_drv_notice_, "+%s()+: enable=%d\n", __func__, enable);
